...
mix.sass('resource/assets/scss/daterangepicker.scss', 'public/js/datepicker/datepicker.min.css').version();
...
mix.scripts(['resource/assets/js/vendor/codemirror/jquery.codemirror.js'], 'public/js/codemirror/jquery.codemirror.min.js').version();
...
mix.sass('resource/assets/js/vendor/codemirror/theme/storm.scss', 'public/js/codemirror/theme/storm.css');
...
mix.scripts('resource/assets/js/vendor/tinymce/plugins/codemirror/plugin.js', 'public/js/tinymce/plugins/codemirror/plugin.min.js');
mix.scripts('resource/assets/js/vendor/tinymce/plugins/customalign/plugin.js', 'public/js/tinymce/plugins/customalign/plugin.min.js');
mix.copy('resource/assets/js/vendor/tinymce/plugins', 'public/js/tinymce/plugins');
...
// Boilerplate skin
mix.copy('resource/assets/js/vendor/tinymce/skins/boilerplate/fonts', 'public/js/tinymce/skins/ui/boilerplate/fonts');
mix.sass('resource/assets/js/vendor/tinymce/skins/boilerplate/content.inline.scss', 'public/js/tinymce/skins/ui/boilerplate/content.inline.min.css');
mix.sass('resource/assets/js/vendor/tinymce/skins/boilerplate/content.mobile.scss', 'public/js/tinymce/skins/ui/boilerplate/content.mobile.min.css');
mix.sass('resource/assets/js/vendor/tinymce/skins/boilerplate/content.scss', 'public/js/tinymce/skins/ui/boilerplate/content.min.css');
mix.sass('resource/assets/js/vendor/tinymce/skins/boilerplate/skin.scss', 'public/js/tinymce/skins/ui/boilerplate/skin.min.css');
mix.sass('resource/assets/js/vendor/tinymce/skins/boilerplate/skin.mobile.scss', 'public/js/tinymce/skins/ui/boilerplate/skin.mobile.min.css');

// https://www.tiny.cloud/get-tiny/language-packages/
mix.copy('resource/assets/js/vendor/tinymce/langs', 'public/js/tinymce/langs');
