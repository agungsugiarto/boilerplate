<nav class="main-header navbar navbar-expand <?= config('Boilerplate')->theme['dark-mode'] ? 'navbar-dark' : 'navbar-' . config('Boilerplate')->theme['navbar']['type']; ?> <?= config('Boilerplate')->theme['navbar']['bg'] ?? 'navbar-' . config('Boilerplate')->theme['navbar']['bg']; ?> <?= config('Boilerplate')->theme['navbar']['type'] ? '' : 'border-bottom-0' ?>">
